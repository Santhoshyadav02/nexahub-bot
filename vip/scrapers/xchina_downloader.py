...
def download_single_video(
    item, output_dir=os.path.join("downloads", "xchina"), timeout=180, max_retries=3
):
    """
    Downloads a single XChina MP4 video file with HTTP Range resume and a live visual percentage progress bar.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="XChina video downloader with live progress percentage"
    )
    parser.add_argument(
        "--json",
