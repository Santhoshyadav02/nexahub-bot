...
def run_javm_scraper(
    board="javm", start_page=1, end_page=None, output_file="javm_videos.json"
):
    saved_data = {}
    ...
    with sync_playwright() as p:
        ...
        if end_page is None:
            ...
            print(f"[*] Detecting total JAV Removed Mosaic pages from {url}...")
        ...
        print(f"\n=======================================================")
        print(
            f"[*] Starting JAV Removed Mosaic Scraper (Pages {start_page} to {end_page})"
        )
        print(f"=======================================================\n")
    ...
    print(
        f"\n[+] JAV Removed Mosaic Scraping Completed! Output saved to '{output_file}' and '{output_file.replace('.json', '.csv')}'"
    )


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV Removed Mosaic Video Scraper")
    parser.add_argument("--board", default="javm", help="Board name (default: javm)")
    parser.add_argument("--start", type=int, default=1, help="Start page")
    parser.add_argument("--end", type=int, default=None, help="End page")
    parser.add_argument(
        "--output", default="javm_videos.json", help="Output JSON filename"
    )
