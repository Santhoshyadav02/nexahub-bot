...
def run_javmgs_scraper(
    board="javmgs", start_page=1, end_page=None, output_file="javmgs_videos.json"
):
    saved_data = {}
    ...
    with sync_playwright() as p:
        ...
        if end_page is None:
            ...
            print(f"[*] Detecting total JAV MGStage pages from {url}...")
        ...
        print(f"\n=======================================================")
        print(f"[*] Starting JAV MGStage Scraper (Pages {start_page} to {end_page})")
        print(f"=======================================================\n")
    ...
    print(
        f"\n[+] JAV MGStage Scraping Completed! Output saved to '{output_file}' and '{output_file.replace('.json', '.csv')}'"
    )


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV MGStage Video Scraper")
    parser.add_argument(
        "--board", default="javmgs", help="Board name (default: javmgs)"
    )
    parser.add_argument("--start", type=int, default=1, help="Start page")
    parser.add_argument("--end", type=int, default=None, help="End page")
    parser.add_argument(
        "--output", default="javmgs_videos.json", help="Output JSON filename"
    )
