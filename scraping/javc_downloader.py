...
DEFAULT_OUTPUT_DIR = os.path.join("downloads", "JAV censored")
...
def download_all_javc_videos(
    json_file="javc_videos.json", output_dir=DEFAULT_OUTPUT_DIR, limit=None
):
    ...
    print("\n=======================================================", flush=True)
    print(f"[*] Starting JAV Censored Video Downloader (Sequential Mode)", flush=True)
    ...
    print("=======================================================", flush=True)
    print(f"[+] JAV Censored Download Summary:", flush=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV Censored MP4 downloader")
    parser.add_argument("--json", default="javc_videos.json", help="Path to JSON file")
    parser.add_argument(
