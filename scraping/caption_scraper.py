...
def run_caption_scraper(
    board="caption", start_page=1, end_page=None, output_file="caption_videos.json"
):
    saved_data = {}
    ...
    with sync_playwright() as p:
        ...
        if end_page is None:
            ...
            print(f"[*] Detecting total JAV Caption board pages from {url}...")
        ...
        print(f"\n=======================================================")
        print(f"[*] Starting JAV Caption Scraper (Pages {start_page} to {end_page})")
        print(f"=======================================================\n")
    ...
    print(
        f"\n[+] JAV Caption Scraping Completed! Output saved to '{output_file}' and '{output_file.replace('.json', '.csv')}'"
    )


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV Caption Video Scraper")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Output JSON filename (default: caption_videos.json)",
    )
