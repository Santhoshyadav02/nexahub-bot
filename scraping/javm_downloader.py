...
DEFAULT_OUTPUT_DIR = os.path.join("downloads", "JAV removed Mosaic")
...
def download_all_javm_videos(
    json_file="javm_videos.json", output_dir=DEFAULT_OUTPUT_DIR, limit=None
):
    ...
    print("\n=======================================================", flush=True)
    print(
        f"[*] Starting JAV Removed Mosaic Video Downloader (Sequential Mode)",
        flush=True,
    )
    ...
    print("=======================================================", flush=True)
    print(f"[+] JAV Removed Mosaic Download Summary:", flush=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV Removed Mosaic MP4 downloader")
    parser.add_argument("--json", default="javm_videos.json", help="Path to JSON file")
    parser.add_argument(
