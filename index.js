...
if (isMainModule) {
  ...
  try {
    if (process.env.MODULAR_PIPELINE_ENABLED !== 'false') {
      ...
      const modularPipeline = getModularPipelineInstance({
        telegramClient: bot,
        workers: Number(process.env.MODULAR_PIPELINE_WORKERS) || 1,
      ...
      console.log("✅ [MODULAR_PIPELINE] Unified 10-Channel Pipeline active (every 2h, 5 videos/day per channel, 50 total/day, 1 download worker).");
    }
  } catch (modErr) {
