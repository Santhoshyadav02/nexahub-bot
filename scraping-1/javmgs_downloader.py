...
DEFAULT_OUTPUT_DIR = os.path.join("downloads", "JAV MGStage")
...
def download_all_javmgs_videos(
    json_file="javmgs_videos.json", output_dir=DEFAULT_OUTPUT_DIR, limit=None
):
    ...
    print("\n=======================================================", flush=True)
    print(f"[*] Starting JAV MGStage Video Downloader (Sequential Mode)", flush=True)
    ...
    print("=======================================================", flush=True)
    print(f"[+] JAV MGStage Download Summary:", flush=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="JAV MGStage MP4 downloader")
    parser.add_argument(
        "--json", default="javmgs_videos.json", help="Path to JSON file"
    )
    parser.add_argument(
